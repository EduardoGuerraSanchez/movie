...
public class SerieActivity extends AppCompatActivity {
        ...
        call.enqueue(new Callback<CreditsFeed>() {
            ...
            public void onResponse(Call<CreditsFeed> call, Response<CreditsFeed> response) {
                switch (response.code()) {
                    ...
                    case 200:
                        CreditsFeed creditsFeed = response.body();
                        serieAdapter.swap(creditsFeed.getCast());
   ...
   public void loadSimilarSeries() {
        ...
        Call<TVShowFeed> call = getMovie.getSimilarSeries(idReal,RetrofitInstance.getApiKey(),getString(R.string.language));
